...
export const AboutMe = () => {
  return (
    ...
    <div id="about" className='mt-1 mb-1 '>
      ...
      <div className='flex min-h-screen items-center justify-center pt-0 py-[2rem] px-4 font-bold'> {/* Add margin-top here to create space for the fixed navbar */}
        ...
        <div className='ml-5 px-2 rounded-md'>
          ...
          <p className='mt-4 text-left text-l font-weight-200 text-[#000000]'>I first dabbled began on my brother's old Macbook, running macOS Snow Leopard, and a "Learn To Program" book. In high school I took my first programming classes.
